...
# ========================= 🌸 Elegant Student Notes Page Generator 🌸 ========================= #
...
def generate_notes_page(chapter_name, topics, answers, all_questions, api_key, cx, images_limit=3):
    ...
    <header>📘 {chapter_name} ✨</header>
    """

    # Generate Topics
    for topic, answer in zip(topics, answers):
        html += f'<div class="topic"><h2>💡 {topic}</h2><div style="white-space: pre-wrap;">{answer}</div>'
        ...
        if results:
            html += '<div class="google-results"><h4>🔗 Related Resources:</h4>'
            for res in results:
                html += f"""
    ...
    html += '<div class="all-questions"><h2>🖊️ All Questions</h2>'
